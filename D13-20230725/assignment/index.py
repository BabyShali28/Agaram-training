...
for trends in trends_mart:
    trends.update(availability={})
    for available in trends["available_for"]:
        avail=available["categ"]
        
        
        if available["qty"]<=5 :
            trends["low_stock"].append(trends["name"])
            if available["qty"]==0:
                
                trends["availability"][avail]="out of stock"
            else:
                trends["availability"][avail]="in stock"
print(trends_mart)
